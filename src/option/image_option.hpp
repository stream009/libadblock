#ifndef ADBLOCK_OPTION_IMAGE_OPTION_HPP
#define ADBLOCK_OPTION_IMAGE_OPTION_HPP
...
class ImageOption : public InvertibleOption, public TypeOption
{
...
#endif // ADBLOCK_OPTION_IMAGE_OPTION_HPP
